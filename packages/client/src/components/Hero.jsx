...
const Home = () => {
  return (
    <div className='flex flex-col-reverse items-center px-6 space-y-0 md:space-y-0 md:flex-row'>
      {/* left */}
      <div className='flex flex-col mb-32 space-y-12 md:w-1/2'>
        ...
        <p className='max-w-sm text-center text-darkGray md:text-left'>
          Welcome! Store your playbills digitally plus a ton more info: date of
          show, city of showing, theatre's name, and more!
        </p>
